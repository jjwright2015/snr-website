...
// --- Data ---
const standingsData = [
  { pos: 1, driver: "Kenny Kibbey", points: 295, wins: 0, top5: 4, top10: 5, starts: 8, laps: 1345, incs: 38, behind: 0 },
  { pos: 2, driver: "Bailey Turner", points: 284, wins: 2, top5: 3, top10: 5, starts: 8, laps: 1333, incs: 30, behind: -11 },
  { pos: 3, driver: "A.J. Stravato", points: 282, wins: 1, top5: 5, top10: 6, starts: 8, laps: 1250, incs: 22, behind: -13 },
  { pos: 4, driver: "Jeff J. Wright", points: 264, wins: 3, top5: 4, top10: 4, starts: 7, laps: 1022, incs: 17, behind: -31 },
  { pos: 5, driver: "Seth Hatchel", points: 262, wins: 0, top5: 2, top10: 7, starts: 7, laps: 1186, incs: 47, behind: -33 },
  { pos: 6, driver: "J R Shepherd", points: 259, wins: 0, top5: 3, top10: 4, starts: 8, laps: 1340, incs: 42, behind: -36 },
  { pos: 7, driver: "Justin Richie", points: 253, wins: 0, top5: 0, top10: 5, starts: 8, laps: 1345, incs: 87, behind: -42 },
  { pos: 7, driver: "Caleb Weekley", points: 253, wins: 0, top5: 1, top10: 4, starts: 8, laps: 1345, incs: 74, behind: -42 },
  { pos: 9, driver: "Phillip Brewer", points: 238, wins: 0, top5: 1, top10: 2, starts: 8, laps: 1330, incs: 34, behind: -57 },
  { pos: 10, driver: "Joshua Banks", points: 229, wins: 1, top5: 3, top10: 4, starts: 7, laps: 1081, incs: 36, behind: -66 },
  { pos: 11, driver: "Elliott Butler", points: 211, wins: 0, top5: 0, top10: 2, starts: 8, laps: 1232, incs: 47, behind: -84 },
  { pos: 12, driver: "Angelo Hronis", points: 210, wins: 0, top5: 1, top10: 4, starts: 7, laps: 1176, incs: 35, behind: -85 },
  { pos: 13, driver: "Casey Lakatos", points: 194, wins: 0, top5: 0, top10: 1, starts: 8, laps: 1345, incs: 74, behind: -101 },
  { pos: 14, driver: "Dakota Floyd2", points: 193, wins: 0, top5: 1, top10: 1, starts: 8, laps: 1311, incs: 50, behind: -102 },
  { pos: 15, driver: "Enathian Ferrada", points: 191, wins: 0, top5: 1, top10: 2, starts: 8, laps: 1136, incs: 60, behind: -104 },
  ...
  { pos: 17, driver: "Chuck Sweeting", points: 172, wins: 0, top5: 1, top10: 1, starts: 8, laps: 1073, incs: 31, behind: -123 },
  { pos: 19, driver: "Christopher Hodges", points: 171, wins: 0, top5: 1, top10: 1, starts: 8, laps: 1199, incs: 45, behind: -124 },
  { pos: 19, driver: "Max Kost", points: 171, wins: 0, top5: 0, top10: 0, starts: 8, laps: 1316, incs: 37, behind: -124 },
  { pos: 21, driver: "Ben Laughter", points: 170, wins: 0, top5: 0, top10: 1, starts: 8, laps: 1262, incs: 82, behind: -125 },
  { pos: 22, driver: "Adam Cabot", points: 168, wins: 0, top5: 3, top10: 4, starts: 5, laps: 733, incs: 31, behind: -127 },
  { pos: 23, driver: "Bryce Shoemaker", points: 163, wins: 0, top5: 0, top10: 0, starts: 7, laps: 1074, incs: 42, behind: -132 },
  { pos: 24, driver: "Andy Telgenhof", points: 146, wins: 1, top5: 1, top10: 2, starts: 4, laps: 740, incs: 29, behind: -149 },
  { pos: 25, driver: "Brandon Wallace", points: 144, wins: 0, top5: 0, top10: 1, starts: 8, laps: 1330, incs: 51, behind: -151 },
  { pos: 26, driver: "Stefan Davis", points: 131, wins: 0, top5: 1, top10: 1, starts: 7, laps: 1118, incs: 44, behind: -164 },
  { pos: 27, driver: "Broderick Vaclavik", points: 130, wins: 0, top5: 0, top10: 0, starts: 7, laps: 1110, incs: 60, behind: -165 },
  { pos: 28, driver: "Rhea Massey", points: 120, wins: 0, top5: 0, top10: 1, starts: 7, laps: 908, incs: 40, behind: -175 },
  { pos: 29, driver: "Matt Shinoski", points: 118, wins: 0, top5: 0, top10: 0, starts: 6, laps: 819, incs: 28, behind: -177 },
  { pos: 30, driver: "Ryan Carwile", points: 113, wins: 0, top5: 0, top10: 2, starts: 5, laps: 736, incs: 29, behind: -182 },
  { pos: 31, driver: "Rob Hamp", points: 110, wins: 0, top5: 1, top10: 1, starts: 6, laps: 877, incs: 78, behind: -185 },
  { pos: 32, driver: "Mikal Jones", points: 107, wins: 0, top5: 1, top10: 1, starts: 7, laps: 962, incs: 44, behind: -188 },
  { pos: 33, driver: "Tim Shinoski", points: 102, wins: 0, top5: 0, top10: 0, starts: 6, laps: 854, incs: 41, behind: -193 },
  { pos: 34, driver: "Reggie Ortega", points: 99, wins: 0, top5: 0, top10: 1, starts: 5, laps: 871, incs: 51, behind: -196 },
  { pos: 35, driver: "James Lehman", points: 93, wins: 0, top5: 0, top10: 1, starts: 7, laps: 868, incs: 28, behind: -202 },
  { pos: 36, driver: "Brian Chambliss", points: 90, wins: 0, top5: 0, top10: 0, starts: 5, laps: 722, incs: 32, behind: -205 },
  { pos: 37, driver: "Bryan Dehn", points: 89, wins: 0, top5: 0, top10: 0, starts: 4, laps: 608, incs: 34, behind: -206 },
  { pos: 37, driver: "Keith Shoemaker", points: 89, wins: 0, top5: 0, top10: 0, starts: 6, laps: 609, incs: 25, behind: -206 },
  { pos: 39, driver: "Eldon Stewart2", points: 79, wins: 0, top5: 0, top10: 0, starts: 7, laps: 972, incs: 54, behind: -216 },
  { pos: 40, driver: "Justin Carey2", points: 78, wins: 0, top5: 0, top10: 1, starts: 4, laps: 722, incs: 47, behind: -217 },
  { pos: 41, driver: "Mark McFadyen", points: 76, wins: 0, top5: 0, top10: 0, starts: 6, laps: 753, incs: 26, behind: -219 },
  { pos: 42, driver: "Chad Clinger", points: 74, wins: 0, top5: 0, top10: 1, starts: 6, laps: 818, incs: 44, behind: -221 },
  { pos: 43, driver: "John Seniw", points: 65, wins: 0, top5: 0, top10: 0, starts: 7, laps: 891, incs: 38, behind: -230 },
  { pos: 44, driver: "Justin Michael", points: 48, wins: 0, top5: 0, top10: 0, starts: 3, laps: 355, incs: 10, behind: -247 },
  { pos: 45, driver: "Kyle Peacock", points: 28, wins: 0, top5: 0, top10: 0, starts: 1, laps: 175, incs: 0, behind: -267 },
  { pos: 46, driver: "Derek M Garrison", points: 25, wins: 0, top5: 0, top10: 0, starts: 1, laps: 140, incs: 4, behind: -270 },
  { pos: 47, driver: "Logan Threlkeld", points: 12, wins: 0, top5: 0, top10: 0, starts: 2, laps: 286, incs: 11, behind: -283 },
